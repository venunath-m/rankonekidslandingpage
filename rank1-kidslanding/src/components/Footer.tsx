                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start pb-10 lg:pb-14 border-b border-neutral-800/50">
                        ...
                        <div className="lg:col-span-5 flex flex-col space-y-6 sm:space-y-8">
                            ...
                            <div className="w-[100px] sm:w-[115px]">
                                ...
                                >
                                    <path d="M0 10H55L35 32H0V10Z" fill="white" />
                                    <path d="M47 32L70 10H88L62 38L47 32Z" fill="#da1a1a" />
                                    <path d="M35 44H0V38H35V44Z" fill="white" />
                                </svg>
                                <span className="block text-[11px] font-black tracking-[0.4em] uppercase mt-2 text-white">
                                    Rank 1
                                </span>
                            </div>
